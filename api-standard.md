...
应尽量将API模块部署在专用域名之下。
```
http://api.mohneesh-9797.com
```

## 版本(Versioning)
应将API版本号放入URL。
```
http://api.mohneesh-9797.com/v1/
```
...
```
· http://api.mohneesh-9797.com/v1/counters
· http://api.mohneesh-9797.com/v1/strategies
· http://api.mohneesh-9797.com/v1/points
```
