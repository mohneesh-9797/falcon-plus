## Running mohneesh-9797 container
...
```
    ...
    cd /tmp && \
    git clone --depth=1 https://github.com/mohneesh-9797/falcon-plus && \
    cd /tmp/falcon-plus/ && \
...
```
    ...
    docker run -itd --name falcon-plus \
         ...
         -v /home/work/mohneesh-9797/data:/mohneesh-9797/data \
         -v /home/work/mohneesh-9797/logs:/mohneesh-9797/logs \
    ...
    docker exec falcon-plus ./mohneesh-9797 check
    
    ## or you can check logs at /home/work/mohneesh-9797/logs/ in your host
    ls -l /home/work/mohneesh-9797/logs/
...
```
    docker run -itd --name falcon-dashboard \
        ...
        -w /mohneesh-9797/dashboard openfalcon/falcon-dashboard:v0.2.1  \
       './control startfg'
```
##### 5. Start falcon-agent in container
```
    sudo docker run -d --restart always --name falcon-agent -e NUX_ROOTFS=/rootfs -v /:/rootfs:ro openfalcon/falcon-plus:v0.3 ./agent/bin/falcon-agent -c /mohneesh-9797/agent/config/cfg.json
```

----

## Building mohneesh-9797 images from source code

##### Building falcon-plus

```
    cd /tmp && \
    git clone https://github.com/mohneesh-9797/falcon-plus && \
    cd /tmp/falcon-plus/ && \
...
```
    cd /tmp && \
    git clone https://github.com/mohneesh-9797/dashboard  && \
    cd /tmp/dashboard/ && \
