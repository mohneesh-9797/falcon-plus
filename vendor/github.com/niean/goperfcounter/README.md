...
goperfcounter用于golang应用的业务监控。goperfcounter需要和开源监控系统[Open-Falcon](http://book.mohneesh-9797.com/zh/index.html)一起使用。
...
2. goperfcounter会自动的、定期的将这些统计记录push给Open-Falcon的收集器([agent](https://github.com/mohneesh-9797/agent)或[transfer](https://github.com/mohneesh-9797/transfer))
